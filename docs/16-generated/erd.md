...
erDiagram
  ...
  ORDERSTATECHANGE }o--|| ORDER : belongs_to
  ORDER ||--o{ ORDERITEM : has_many
  ORDER ||--o{ ORDERSTATECHANGE : has_many
  ...
  ORDERITEM {
    ...
    integer quantity
    string unit
    integer unit_price_vat_cents
    integer vat_rate_percent
    integer discount_percent
    integer total_ex_vat_cents
    integer total_vat_cents
    string line_type
    string currency
  }
  ORDERSTATECHANGE {
  ...
  ORDER {
    ...
    string total_vat_cents
    string currency
    datetime fetched_at
    string source_raw_hash
    boolean is_completed
    string last_state_code
    string external_edit_id
  }
  CONTACTCUSTOMFIELD {
    string contact_id
    string key
