@extends('layouts.vertical', ['title' => 'Nový kontakt'])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Nový kontakt</li>
                    </ol>
                </div>
                <h4 class="page-title">Nový kontakt</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info mb-4">
                        ...
                        Vytvořte nový kontakt v CRM systému. Povinná pole jsou označena hvězdičkou (*).
                    </div>

                    <form action="{{ url('/crm/contacts') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <select class="form-select @error('preferred_contact') is-invalid @enderror" 
                                    ...
                                    <option value="phone" {{ old('preferred_contact') == 'phone' ? 'selected' : '' }}>Telefon</option>
                                    <option value="mobile" {{ old('preferred_contact') == 'mobile' ? 'selected' : '' }}>Mobil</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          ...
                                          placeholder="Úplná adresa kontaktu">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('country') is-invalid @enderror" 
                                       id="country" name="country" value="{{ old('country', 'Česká republika') }}" 
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          ...
                                          placeholder="Jakékoliv další informace o kontaktu...">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ url('/crm/contacts') }}" class="btn btn-light">
