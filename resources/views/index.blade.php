...
<div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1">
    <div class="col">
        <div class="card">
            <div class="d-flex card-header justify-content-between align-items-center">
                <div>
                    <h4 class="header-title">Aktivní příležitosti</h4>
                </div>
                <div></div>
            </div>
            ...
            <div class="card-body pt-0">
                <div class="d-flex align-items-end gap-2 justify-content-between">
                    ...
                    <div class="text-end">
                        ...
                        <p class="text-muted mb-0">Mezi‑měsíčně</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card">
            <div class="d-flex card-header justify-content-between align-items-center">
                <div>
                    <h4 class="header-title">Hodnota pipeline</h4>
                </div>
                <div></div>
            </div>
    ...
    <div class="col">
        <div class="card">
            <div class="d-flex card-header justify-content-between align-items-center">
                <div>
                    <h4 class="header-title">Nové kontakty</h4>
                </div>
                <div></div>
            </div>
    ...
    <div class="col">
        <div class="card">
            <div class="d-flex card-header justify-content-between align-items-center">
                <div>
                    <h4 class="header-title">Spokojenost zákazníků</h4>
                </div>
                <div></div>
            </div>
    ...
    <div class="col-xxl-4 col-xl-6">
        <div class="card">
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-dashed">
                <h4 class="header-title">Statistiky objednávek</h4>

                <div class="d-flex gap-2 justify-content-end text-end">
                    <a href="javascript:void(0);" class="btn btn-sm btn-light">Obnovit <i class="ri-refresh-line ms-1"></i></a>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-between align-items-center p-1">
                                <div>
                                    ...
                                    <span class="align-middle fw-semibold">Přímé</span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center p-1">
                                <div>
                                    ...
                                    <span class="align-middle fw-semibold">Sociální</span>
                                </div>
