        ...
        <div class="col-xxl-3 col-lg-5 col-md-6">
            ...
            <div class="card overflow-hidden text-center p-xxl-4 p-3 mb-0">
                ...
                <div class="text-center">
                    ...
                    <h3 class="mt-3 mb-2">Chybný požadavek</h3>
                    <p class="text-muted mb-3">Server nerozuměl požadavku kvůli neplatné syntaxi. Zkontrolujte vstupy a zkuste to znovu.</p>
