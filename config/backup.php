...
return [
    // Custom schedule toggle for this app
    'schedule' => [
        'enabled' => env('BACKUP_SCHEDULE_ENABLED', false),
        // Default: daily at 03:00
        'cron' => env('BACKUP_SCHEDULE_CRON', '0 3 * * *'),
    ...
    'backup' => [
        ...
        'source' => [
             ...
             */
            'databases' => [
                // Use a dedicated backup connection to avoid auth plugin incompatibilities
                env('BACKUP_DB_CONNECTION', 'mysql_backup'),
            ],
        ],
    ...
    'notifications' => [
        'notifications' => [
            // Disable sending notifications by default to avoid SMTP errors in non-configured environments.
